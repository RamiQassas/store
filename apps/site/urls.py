...
urlpatterns = [
    ...
    path("control/payment-gateways/", views.payment_gateway_integrations_list, name="payment_gateway_integrations_list"),
    path("control/payment-gateways/create/", views.payment_gateway_integration_create, name="payment_gateway_integration_create"),
    path("control/payment-gateways/<uuid:pk>/edit/", views.payment_gateway_integration_edit, name="payment_gateway_integration_edit"),
    path("control/payment-gateways/<uuid:pk>/delete/", views.payment_gateway_integration_delete, name="payment_gateway_integration_delete"),
    ...
    path("control/categories/<uuid:pk>/quick-rename-ajax/", views.control_category_quick_rename_ajax, name="control_category_quick_rename_ajax"),
    ...
    path("control/categories/<uuid:pk>/reorder-ajax/", views.control_category_reorder_ajax, name="control_category_reorder_ajax"),
    ...
    path("control/products/<uuid:pk>/quick-image-ajax/", views.control_product_quick_image_ajax, name="control_product_quick_image_ajax"),
    path("control/products/<uuid:pk>/quick-rename-ajax/", views.control_product_quick_rename_ajax, name="control_product_quick_rename_ajax"),
    path("control/products/<uuid:pk>/edit/", views.control_product_edit, name="control_product_edit"),
    path("control/products/<uuid:pk>/generate-ai-image/", views.control_product_generate_image, name="control_product_generate_image"),
    path("control/categories/<uuid:pk>/generate-ai-image/", views.control_category_generate_image, name="control_category_generate_image"),
    ...
    path("control/variants/transfer-ajax/", views.control_variant_transfer_ajax, name="control_variant_transfer_ajax"),
    path("control/products/change-category-ajax/", views.control_product_change_category_ajax, name="control_product_change_category_ajax"),
    path("control/orders/", views.control_orders_list, name="control_orders_list"),
    path("control/orders/sync-live/", views.control_orders_sync_live_ajax, name="control_orders_sync_live_ajax"),
    path("control/orders/sync-all/", views.control_orders_sync_all_view, name="control_orders_sync_all"),
    ...
    path("control/marketing/meta-ads/", views.control_meta_ads_dashboard, name="control_meta_ads_dashboard"),
    ...
    path("control/api-integrations/<uuid:pk>/edit/", views.control_api_integration_edit, name="control_api_integration_edit"),
    path("control/api-integrations/<uuid:pk>/delete/", views.control_api_integration_delete, name="control_api_integration_delete"),
