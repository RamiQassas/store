...
# Brand logos are handled locally via apps.catalog.image_caching


@register.simple_tag
def product_display_image(product):
    """
    Returns the fastest, 100% reliable local image URL for a product:
    Direct product image, thumbnail, cover, gallery, local brand vector SVG,
    category image, or digital card fallback. Never broken or empty.
    """
