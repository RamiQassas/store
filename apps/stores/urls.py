...
urlpatterns = [
    ...
    path("merchant/products/<uuid:pk>/change-category-ajax/", site_views.control_product_change_category_ajax, name="control_product_change_category_ajax"),
    path("merchant/products/change-category-ajax/", site_views.control_product_change_category_ajax, name="control_product_change_category_ajax_alt"),
    ...
    path("merchant/marketing/meta-ads/", site_views.control_meta_ads_dashboard, name="merchant_meta_ads_dashboard"),
