...
CSRF_COOKIE_SAMESITE = "Lax"
SESSION_COOKIE_SAMESITE = "Lax"
SESSION_COOKIE_AGE = env_int("SESSION_COOKIE_AGE", 7 * 24 * 60 * 60)  # 1 week (604800 seconds)
SESSION_IDLE_TIMEOUT = env_int("SESSION_IDLE_TIMEOUT", 7 * 24 * 60 * 60)  # 1 week (604800 seconds)
