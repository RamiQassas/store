...
CSRF_COOKIE_SAMESITE = "Lax"
SESSION_COOKIE_SAMESITE = "Lax"
SESSION_COOKIE_AGE = max(env_int("SESSION_COOKIE_AGE", 7 * 24 * 60 * 60), 7 * 24 * 60 * 60)  # 1 week (604800 seconds)
SESSION_IDLE_TIMEOUT = max(env_int("SESSION_IDLE_TIMEOUT", 7 * 24 * 60 * 60), 7 * 24 * 60 * 60)  # 1 week (604800 seconds)
SESSION_SAVE_EVERY_REQUEST = True  # Automatically extends session lifetime with every active request
...
CELERY_BEAT_SCHEDULE = {
    ...
    "sync_pending_api_orders_every_30s": {
