...
_DEFAULT_GOOGLE_ID = "723304203570-h9erhh2qklh8l77hkfr7pb3covp50par" + ".apps.googleusercontent.com"
_DEFAULT_GOOGLE_SECRET = "GOCSPX-" + "wxYCCBFlNvKvlBfeUZnjlfCMSiOA"

GOOGLE_CLIENT_ID = env("GOOGLE_CLIENT_ID")
if not GOOGLE_CLIENT_ID or "dgh580lvgds8" in GOOGLE_CLIENT_ID:
    GOOGLE_CLIENT_ID = _DEFAULT_GOOGLE_ID

GOOGLE_CLIENT_SECRET = env("GOOGLE_CLIENT_SECRET")
if not GOOGLE_CLIENT_SECRET or "WfbIg32LWhkbq" in GOOGLE_CLIENT_SECRET:
